            ...
            if bill_num == row2[1].value and typ == row2[5].value:
                if typ == u"ОС":
                    ...
                    if name == row2[4].value:
                        is_found = True
                        is_changed = (passport != row2[6].value or uaddr != row2[7].value or paddr != row2[
                            8].value or ao != row2[9].value or ag != row2[10].value)
                elif typ == u"ЮЛ":
                    is_found = True
                    is_changed = (
                                name != row2[4].value or uaddr != row2[7].value or paddr != row2[8].value or ao != row2[
                            9].value or ag != row2[10].value)
                if is_found:
                    break
